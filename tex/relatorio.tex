...
\begin{enumerate}
	...
	\item Atendimento a Clientes
	\begin{center}
 		\includegraphics[width = 4in]{ac_adicionacomp.png} \\
 		\includegraphics[width = 4in]{ac_adicionapacote.png} \\
		\includegraphics[width = 4in]{ac_configotima.png} \\
		\includegraphics[width = 4in]{ac_consultarcliente.png} \\
		\includegraphics[width = 4in]{ac_altcliente.png} \\
		\includegraphics[width = 4in]{ac_idcliente.png} \\
		\includegraphics[width = 4in]{ac_regcliente.png} \\
		\includegraphics[width = 4in]{ac_regenc.png}
	\end{center}
	\newpage
	\item Gestão de Fábrica
	\begin{center}
		\includegraphics[width = 4in]{gf_consultarencomenda.png} \\
 		\includegraphics[width = 4in]{gf_processarencomenda.png} \\
		\includegraphics[width = 4in]{gf_encomendarstock.png} \\
		\includegraphics[width = 4in]{gf_registarstock.png}
	\end{center}
	\newpage
	\item Gestão de Funcionários
	\begin{center}
		\includegraphics[width = 4in]{gfunc_registar.png} \\
 		\includegraphics[width = 4in]{gfunc_alterar.png} \\
		\includegraphics[width = 4in]{gfunc_remover.png}
	\end{center}
\end{enumerate}
